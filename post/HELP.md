...
* [Spring Web Services](https://docs.spring.io/spring-boot/docs/3.1.8/reference/htmlsingle/index.html#io.webservices)
...
* [Java Mail Sender](https://docs.spring.io/spring-boot/docs/3.1.8/reference/htmlsingle/index.html#io.email)
